...
Toolbar ct;
Button save;
    public static final String JSON_URL_UPDATE = "https://nupola.com/app/saveDetails.php";
    ProgressDialog progress;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit);
        String member = Edit.this.getIntent().getExtras().getString("member");
        String phone = Edit.this.getIntent().getExtras().getString("phone");
        String gname = Edit.this.getIntent().getExtras().getString("gname");
        ct=(Toolbar)findViewById(R.id.ctbarxedit);
        ct.setTitle(member+" in "+gname);
        ct.setTitleTextColor(Color.WHITE);

        nam=(EditText)findViewById(R.id.mname);
        ph=(EditText)findViewById(R.id.mphone);
        nam.setText(member);
        ph.setText(phone);
    ...
    class C03982d implements Response.ErrorListener {
        ...
        public void onErrorResponse(VolleyError error) {
            ...
            Toast.makeText(Edit.this,"Network Error!", Toast.LENGTH_SHORT).show();
            progress.dismiss();
    ...
    private void saveDetails() {
        String member = Edit.this.getIntent().getExtras().getString("member");
        final String phone = Edit.this.getIntent().getExtras().getString("phone");
        final String gname = Edit.this.getIntent().getExtras().getString("gname");

        this.progress = ProgressDialog.show(this, "Saving Details", "Please Wait...", true);
        Volley.newRequestQueue(this).add(new StringRequest(1, JSON_URL_UPDATE, new Edit.C03971d(), new Edit.C03982d()) {
