...
public class Members extends AppCompatActivity implements ContactsAdaptermembers.ContactsAdapterListener, View.OnClickListener {
    // private static final String TAG = Friends.class.getSimpleName();
    private RecyclerView recyclerView;
    private List<Contactmembers> contactList;
    private ContactsAdaptermembers mAdapter;
    private SearchView searchView;
    Context mcontext;
    LoginDataBaseAdapter2 loginDataBaseAdapter;
    ProgressDialog progress;
    Utils utils;
    FloatingActionButton smsbtn,morebtn;
    public static final String JSON_URL_DELETE = "http://nupola.com/app/deletegroup_large.php";


    // url to fetch contacts json
    private static final int RESULT_PICK_CONTACT = 85500;
    public static final String URLTWOM = "http://api.androidhive.info/json/contacts.json";
    public static final String URLTWO = "http://nupola.com/app/members.php?gid=";
    public static final String CON_URL = "http://www.nupola.com/app/add_member.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        smsbtn = (FloatingActionButton) findViewById(R.id.smsmembers);
        smsbtn.setOnClickListener(this);

        morebtn = (FloatingActionButton) findViewById(R.id.more);
        morebtn.setOnClickListener(this);

        // toolbar fancy stuff
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        final String gid = Members.this.getIntent().getExtras().getString("id");


       final String gname = Members.this.getIntent().getExtras().getString("gname");
        getSupportActionBar().setTitle(gname + " members");

        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Members.this, Large.class);
        ...
        mAdapter = new ContactsAdaptermembers(this, contactList, this);
        ...
        recyclerView.addItemDecoration(new MyDividerItemDecorationmembers(this, DividerItemDecoration.VERTICAL, 36));
...
// add PhoneStateListener
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, CON_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Members.this, error.toString(), Toast.LENGTH_LONG).show();
                        progress.dismiss();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() {
                final String gname = Members.this.getIntent().getExtras().getString("gname");
                final String gid = Members.this.getIntent().getExtras().getString("id");
                String storedcode = loginDataBaseAdapter.getSinlgeEntry1();
                Map<String, String> params = new HashMap<String, String>();
                params.put("gname", gname);
                params.put("gid", gid);
                params.put("code", storedcode);
    ...
    private void showJSON3(String json) throws JSONException, InterruptedException {
        if (json.equals("true\n")) {
            ...
            v.vibrate(600); // 2000 miliseconds = 2 seconds
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
            alertDialogBuilder.setMessage("This is already a members of this group.");
    ...
    public void onClick(View view) {
        ...
        if (view == smsbtn) {
            ...
            Intent intent = new Intent(Members.this, Auth.class);
            ...
            Intent intent = new Intent(Members.this, Authx.class);
            intent.putExtra("gid", gid);
            intent.putExtra("gname", gname);
            startActivity(intent);
    ...
    class C03982 implements Response.ErrorListener {
        ...
        public void onErrorResponse(VolleyError error) {
            progress.dismiss();
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Members.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(Members.this);
                    alertDialog.setTitle("Sorry");
                    alertDialog.setMessage("We have encountered an internal error while processing your request!");
                    alertDialog.setPositiveButton("OK", new Members.C02821());
                    alertDialog.setNegativeButton("Cancel", new Members.C02832());
    ...
    private void fetchContactsf() {
        ...
        String gname = Members.this.getIntent().getExtras().getString("gname");
        String gid = Members.this.getIntent().getExtras().getString("id");
        JsonArrayRequest request = new JsonArrayRequest(URLTWO + gid,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        List<Contactmembers> items = new Gson().fromJson(response.toString(), new TypeToken<List<Contactmembers>>() {
                        }.getType());
                        LinearLayout linlaHeaderProgress = (LinearLayout) findViewById(R.id.linlaHeaderProgressf);
                        linlaHeaderProgress.setVisibility(View.GONE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search_friends) {
            return true;
        } else if (id == R.id.action_addm) {
            String gid = Members.this.getIntent().getExtras().getString("id");
            String gname = Members.this.getIntent().getExtras().getString("gname");
            Intent intent = new Intent(Members.this, addRes.class);
            intent.putExtra("gname", gname);
            intent.putExtra("gid", gid);
            startActivity(intent);
        ...
        else if (id == R.id.action_refreshfm) {
    ...
    @Override
    public void onContactSelected(final Contactmembers contactdisp) {
            ...
            alertDialogBuilder.setPositiveButton("SETTINGS",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            ...
                            String gname = Members.this.getIntent().getExtras().getString("gname");
                            String gid = Members.this.getIntent().getExtras().getString("id");
                            Intent intent = new Intent(Members.this, settings.class);
                            intent.putExtra("gname", gname);
                            intent.putExtra("gid", gname);
    ...
    class C039714 implements Response.Listener<String> {
        ...
        public void onResponse(String response) {
            Members.this.progress.dismiss();

                Members.this.showJSONx(response);
    ...
    class C039824 implements Response.ErrorListener {
        ...
        public void onErrorResponse(VolleyError error) {
            ...
            Toast.makeText(Members.this,"Network Error!", Toast.LENGTH_SHORT).show();
            progress.dismiss();
    ...
    private void sendsms(final String id) {
        ...
        Volley.newRequestQueue(this).add(new StringRequest(1, JSON_URL, new Members.C039714(), new Members.C039824()) {
            protected Map<String, String> getParams() {
    ...
    class C03971d implements Response.Listener<String> {
        ...
        public void onResponse(String response) {
            ...
            Members.this.showJSONd(response);
    ...
    private void sendRequestd(final String id) {
        ...
        Volley.newRequestQueue(this).add(new StringRequest(1, JSON_URL_DELETE, new Members.C03971d(), new Members.C03982d()) {
            protected Map<String, String> getParams() {
