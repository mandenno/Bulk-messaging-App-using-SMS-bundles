...
{
		static final String DATABASE_NAME = "largegroup.db";
		...
		public void insertEntry(String code, String resp)
		{
	       ContentValues newValues = new ContentValues();
			// Assign values for each row.
			newValues.put("USERNAME", code);
			newValues.put("PASSWORD",resp);
