...
public class ContactFragment extends BaseFragment {
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootLayout = super.createView(inflater, com.onegravity.contactpicker.R.layout.cp_contact_list, mAdapter, mContacts);

        // configure fast scroll
        RecyclerView recyclerView = (RecyclerView) rootLayout.findViewById(android.R.id.list);
        VerticalRecyclerViewFastScroller fastScroller = (VerticalRecyclerViewFastScroller) rootLayout.findViewById(com.onegravity.contactpicker.R.id.fast_scroller);
        fastScroller.setRecyclerView(recyclerView);
        recyclerView.addOnScrollListener(fastScroller.getOnScrollListener());

        // configure section indexer
        SectionTitleIndicator sectionTitleIndicator = (SectionTitleIndicator) rootLayout.findViewById(com.onegravity.contactpicker.R.id.fast_scroller_section_title_indicator);
