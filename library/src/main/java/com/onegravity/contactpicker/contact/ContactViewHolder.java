...
public class ContactViewHolder extends RecyclerView.ViewHolder {
    ...
    ContactViewHolder(View root, ContactPictureManager contactPictureLoader, ContactPictureType contactPictureType,
        ...
        mRoot = root;
        mName = (TextView) root.findViewById(com.onegravity.contactpicker.R.id.name);
        mDescription = (TextView) root.findViewById(com.onegravity.contactpicker.R.id.description);
        mBadge = (ContactBadge) root.findViewById(com.onegravity.contactpicker.R.id.contact_badge);
        mSelect = (CheckBox) root.findViewById(com.onegravity.contactpicker.R.id.select);
